...
FROM error_synthea_data_quality_2025
...
if df.empty:
    print("Nav atrastu datu kvalitātes problēmu rezultātu tabulā `error_synthea_data_quality_2025`.")
else:
    ...
    plt.title('Kļūdaino datu kvalitātes novērtējums pa tabulām un kvalitātes dimensijām', pad=20, fontsize=14)
    ...
    plt.title('\n Kļūdaino datu kvalitātes siltuma karte', pad=20, fontsize=14)
